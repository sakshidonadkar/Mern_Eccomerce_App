...
//     const response = await axios.get(`${server}/products/get-all`);
//     const products = response.data;

//     dispatch({ type: 'fetchProductsSuccess', payload: products });
//   } catch (error) {
//     dispatch({ type: 'fetchProductsFail', payload: error.message });
//   }
// };